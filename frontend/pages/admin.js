...
const Products = () => {
  ...
  return (
    <ProductForm>
      ...
      <div style={{background:"darkgray", padding:"2em", borderRadius:"10px", width:"80%",margin:"0 auto"}}>
      <h2 style={{textAlign:"center", fontSize:"2rem"}}>Welcome to Bluecity Admin page</h2>

<div style={{display:"flex" , justifyContent:"space-around",flexWrap:"wrap"}}>
      <div>
      <InputHold>
        <labl style={{fontSize:"1.5rem", marginBottom:".5em"}}>Name*</labl>
        <Input
          type=""
          placeholder=""
          value={formData.name}
      ...
      <InputHold>
        <label style={{fontSize:"1.5rem", marginBottom:".5em"}}>Description *</label>
        <Textarea
          type=""
          placeholder=""
      ...
      <InputHold>
        <label style={{fontSize:"1.5rem", marginBottom:".5em"}}>Category *</label>
        <Input
          type=""
          placeholder=""
      ...
      <InputHold>
        <label style={{fontSize:"1.5rem", marginBottom:".5em"}}>Regularprice *</label>
        <Input
          type=""
          placeholder=""
      ...
      <div>
      <InputHold>
        <label style={{fontSize:"1.5rem", marginBottom:".5em"}}>Salesprice *</label>
        <Input
          type=""
          placeholder=""
      ...
      <InputHold>
        <label style={{fontSize:"1.5rem", marginBottom:".5em"}}>Image *</label>
        <Input
          type="file"
          name="single"
      ...
      <InputHold>
                ...
                <Input type="file"  name="multiple" placeholder="File Upload"  onChange={(e) => uploadImange(e)} multiple  style={{width:"50%", padding:"2em",cursor:"pointer"}}   />
            </InputHold>
            </div>
            </div>

      <div>
        <SubmitButton onClick={handleProduct} disabled={submitting} style={{cursor: submitting===false && "pointer"}}>Submit and Send</SubmitButton>
      </div>
      <p>{Message}</p>
      </div>
    </ProductForm>
